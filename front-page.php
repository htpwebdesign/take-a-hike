		...
		while ( have_posts() ) :
			...
			<section class="hero-section">
				...
				<div class="activities">
					...
					?>
						<h2><?php the_field('activity_title_1'); ?></h2>
					<?php
					...
					if (function_exists ( 'get_field' )) :
					?>
						<h2><?php the_field('activity_title_2'); ?></h2>
						<?php
					...
					if (function_exists ( 'get_field' )) :
					?>
						<h2><?php the_field('activity_title_3'); ?></h2>
					<?php
					...
					if (function_exists ( 'get_field' )) :
					?>
						<h2><?php the_field('activity_title_4'); ?></h2>
					<?php
				...
				<?php
					if (function_exists ( 'get_field' )) :
					?>
						<h2><?php the_field('featured_products_title'); ?></h2>
					<?php
			...
			<section class="mid-section">
				...
				<?php
					if (function_exists ( 'get_field' )) :
					?>
						<h2><?php the_field('bundles_title'); ?></h2>
					<?php
